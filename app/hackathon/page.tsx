    ...
    <div className="relative min-h-screen bg-black text-white font-sans selection:bg-white/20">
      ...
      <div className="relative z-10">
        ...
        <section id="overview" className="relative flex flex-col items-center justify-center text-center px-4 pt-24 pb-20 sm:pt-32 sm:pb-24 min-h-[85vh] scroll-mt-24">
          ...
          <motion.div
            {...fade(0.5)}
            className="flex flex-col mt-4 lg:mt-0 lg:absolute lg:bottom-8 lg:right-8 p-6 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md w-full max-w-[300px] lg:max-w-[260px] text-left shadow-2xl transition-all hover:bg-white/[0.05] hover:border-white/20"
          >
