    ...
    <AnimatePresence mode="wait">
      {activeNotif === 'register' && (
        <motion.div
          ...
          className="fixed top-20 right-4 sm:top-24 sm:right-8 z-[100] max-w-[260px] sm:max-w-[320px] w-[calc(100vw-32px)] sm:w-full"
        >
          <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_-10px_rgba(34,211,238,0.3)] p-4 sm:p-5 pt-5 sm:pt-6">
            <motion.div
              initial={{ width: "100%" }}
              animate={{ width: "0%" }}
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                ...
                <a 
                  ...
                  className="inline-block text-[10px] sm:text-xs font-bold text-black bg-white px-3 sm:px-4 py-1 sm:py-1.5 rounded-full hover:bg-neutral-200 transition-colors"
                >
                  Register Now
                </a>
              </div>
